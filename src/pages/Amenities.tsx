...
const ourSpaces = [
  { 
    ...
    label: "Convenient",
    title: "Parking", 
    description: "Street parking available for residents" 
  },
  { 
    image: petsImage, 
    icon: Dog,
    ...
    description: "A welcoming space for residents and their furry friends" 
  },
  { 
    image: forestImage, 
    icon: Trees,
    label: "Peaceful Oasis",
    title: "Nature at Your Doorstep", 
    description: "Forest views and Mt. Scott Park just steps away" 
  },
  { 
    image: poolImage, 
    icon: Waves,
    label: "Mt. Scott Park",
    title: "Park Swimming Pool", 
